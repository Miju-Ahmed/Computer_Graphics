...
def visizlize_clipping(window,lines):
    ...
    for i,(title,line) in enumerate(lines.items()):
        ...
        accepted,cl_x1,cl_y1,cl_x2,cl_y2=cohen_sutherland_line_clip(x1,y1,x2,y2,xmin,ymin,xmax,ymax)
        if accepted:
...
if __name__ == "__main__":
    ...
    visizlize_clipping(CLIP_WINDOW, test_lines)